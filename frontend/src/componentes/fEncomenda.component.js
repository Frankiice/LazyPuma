...
export default class EncomendasF extends Component {
  constructor(props) {
    super(props);
    this.state = {
      nickname: "",
  ...
  componentDidMount() {
    fetch("http://localhost:5000/user/userData", {
      ...
      .then((data) => {
        ...
        fetch(`http://localhost:5000/fornecedor/orderHistory/${data.data._id}`)
  ...
  return (
    ...
    <div class="row">
        ...
        <div class="cardP border shadow-0 custom-cardUP">
            <div class="m-4">
            <h2 class="card-title mb-4 text-dark">{this.state.nickname}'s Complete Sales</h2>
            <br></br>

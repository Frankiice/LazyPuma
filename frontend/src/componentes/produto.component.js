...
adicionarCarrinho() {
    const novoProduto = { nome: this.state.produto._doc.name, preco: this.state.produto.price, quantidade: this.state.quantidade, img:this.state.produto._doc.img, preco_original:this.state.produto.price, propriedades: this.state.propriedades, id_produto: this.state.produto._doc._id};
